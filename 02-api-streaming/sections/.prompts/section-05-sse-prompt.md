...
Generate content for section `section-05-sse` (filename: `section-05-sse.md`).
...
for `section-05-sse` to understand what this section should contain.
...
`C:\git_repos\playground\hackathon\02-api-streaming/sections/section-05-sse.md`
