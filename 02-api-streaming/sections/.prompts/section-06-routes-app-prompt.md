...
Generate content for section `section-06-routes-app` (filename: `section-06-routes-app.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\git_repos\playground\hackathon\02-api-streaming/claude-plan.md` - Full implementation plan
2. `C:\git_repos\playground\hackathon\02-api-streaming/claude-plan-tdd.md` - Test stubs for each section
3. `C:\git_repos\playground\hackathon\02-api-streaming/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-routes-app` to understand what this section should contain.
...
`C:\git_repos\playground\hackathon\02-api-streaming/sections/section-06-routes-app.md`
