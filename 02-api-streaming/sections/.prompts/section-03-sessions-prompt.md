...
Generate content for section `section-03-sessions` (filename: `section-03-sessions.md`).
...
for `section-03-sessions` to understand what this section should contain.
...
`C:\git_repos\playground\hackathon\02-api-streaming/sections/section-03-sessions.md`
