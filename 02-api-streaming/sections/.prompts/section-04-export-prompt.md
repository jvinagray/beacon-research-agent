...
Generate content for section `section-04-export` (filename: `section-04-export.md`).
...
for `section-04-export` to understand what this section should contain.
...
`C:\git_repos\playground\hackathon\02-api-streaming/sections/section-04-export.md`
