...
Generate content for section `section-06-synthesize` (filename: `section-06-synthesize.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\git_repos\playground\hackathon\01-agent-pipeline/claude-plan.md` - Full implementation plan
2. `C:\git_repos\playground\hackathon\01-agent-pipeline/claude-plan-tdd.md` - Test stubs for each section
3. `C:\git_repos\playground\hackathon\01-agent-pipeline/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-synthesize` to understand what this section should contain.
...
`C:\git_repos\playground\hackathon\01-agent-pipeline/sections/section-06-synthesize.md`
