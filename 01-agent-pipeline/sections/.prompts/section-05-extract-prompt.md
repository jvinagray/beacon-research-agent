...
Generate content for section `section-05-extract` (filename: `section-05-extract.md`).
...
for `section-05-extract` to understand what this section should contain.
...
`C:\git_repos\playground\hackathon\01-agent-pipeline/sections/section-05-extract.md`
