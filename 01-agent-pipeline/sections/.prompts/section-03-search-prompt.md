...
Generate content for section `section-03-search` (filename: `section-03-search.md`).
...
for `section-03-search` to understand what this section should contain.
...
`C:\git_repos\playground\hackathon\01-agent-pipeline/sections/section-03-search.md`
