...
Generate content for section `section-04-evaluate` (filename: `section-04-evaluate.md`).
...
for `section-04-evaluate` to understand what this section should contain.
...
`C:\git_repos\playground\hackathon\01-agent-pipeline/sections/section-04-evaluate.md`
