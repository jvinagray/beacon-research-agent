...
Generate content for section `section-02-models` (filename: `section-02-models.md`).
...
for `section-02-models` to understand what this section should contain.
...
`C:\git_repos\playground\hackathon\01-agent-pipeline/sections/section-02-models.md`
